const Limitation = ({icon,title,content,style}) => {
  return (
    <>
      <div className={`w-full h-auto flex items-start mt-10 bg-white shadow-[8px_10px_40px_0px_rgba(0,0,0,0.1)] rounded-2xl lg:w-2/5 ${style} xl:w-1/3`}>
